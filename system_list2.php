        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
              <a href="system_list2.php" class="nav-link active">VB.Net Based Systems</a>
              </li>
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            ...
            <?php
              ...
              $topics_query->execute(['category' => 'VBS', 'status' => 'Published']);
            ...
            <?php $tbl_comment_query = $conn->query("SELECT * FROM tbl_comments WHERE topic_id='$topics_row[topic_id]' ORDER BY comment_id DESC"); ?>
              ...
              <div class="post col-xl-6">
                ...
                <a href="instructions.php?topic_id=<?php echo $topics_row['topic_id']; ?>&category=VBS&entryNum=<?php echo $topics_row['entryNum']; ?>&viewer=Guest" title="Click to read more...">
                ...
                <div class="post-details">
                  <div class="post-footer d-flex align-items-center flex-column flex-sm-row" style="margin-top: 8px; margin-bottom: 8px;">
                    <div class="d-flex align-items-center flex-wrap">       
                      <div class="date"><i class="icon-clock"></i> <?php echo $topics_row['datePublisheded']; ?></div>
